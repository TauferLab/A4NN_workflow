...
SAMPLING = [
    ...
    ("bin_random", RandomSampling, {'var_type': bool}),
    ("int_random", RandomSampling, {'var_type': int})
]
...
CROSSOVER = [
    ...
    ("int_sbx", SimulatedBinaryCrossover, dict(prob=1.0, eta=30, var_type=int)),
...
MUTATION = [
    ...
    ("int_pm", PolynomialMutation, dict(var_type=int)),
